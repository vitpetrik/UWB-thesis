...
```{julia}
#| label: fig-bpm-bpsk
#| fig-cap: "Example of BPS-BPSK modulation,"
#| output: true
#| width: 70%
...
pl_00 = plot(x*1e9, pulse.((x.-20e-9)*2.5e8), title="0 0";config...)
pl_01 = plot(x*1e9, pulse.((x.-20e-9 .- 64e-9)*2.5e8), title="0 1";config...)
pl_10 = plot(x*1e9, -pulse.((x.-20e-9)*2.5e8), title="1 0";config...)
pl_11 = plot(x*1e9, -pulse.((x.-20e-9 .- 64e-9)*2.5e8), title="1 1";config...)
...
![Double sided two way ranging](images/two_way_ranging.svg){#fig-ds-twr}
