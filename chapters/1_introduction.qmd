...
The problem of relative localization in UAV swarms is a critical challenge for enabling cooperative behavior and avoiding collisions.
...
By fusing these measurements using a Kalman filter, the relative positions and orientations of UAVs can be estimated with high accuracy, even in GNSS-denied environments such as buildings or underground areas @petrlik2023uavs. 
...
This thesis addresses designing and implementing an effective relative localization system for UAV swarms using computer vision and UWB technology, and evaluates how well does it perform in real-world scenarios. 
Firstly, a review of the proposed system and its key components, including the computer vision algorithms for direction estimation and the UWB hardware for range measurement, will be presented. 
