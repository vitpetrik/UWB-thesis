...
Article *Decentralized Visual-Inertial-UWB Fusion for Relative State Estimation of Aerial Swarm* [@9196944] proposes system architecture and the fusion algorithm, which combines visual-inertial odometry (VIO) and UWB ranging measurements in a tightly-coupled manner.