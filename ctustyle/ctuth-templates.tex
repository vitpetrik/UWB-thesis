...
\ctutemplateset{titlepage}{
	...
	\vbox to \dimexpr\textheight + \baselineskip + \headsep + \footskip{
		...
		\includegraphics[height=3cm]{ctustyle/logo_CVUT.pdf}\
		\vspace*{8mm}
		\begin{tabular}{@{}l@{\hspace*{17.4mm}}l@{}}
			\\[3ex]
				\raisebox{-8pt}{
					\color{ctubluetext}\fontsize{32.7}{32.7}\selectfont\fontspec{Technika}
					...
					%			\end{tabular}
					&
					\begin{tabular}[c]{@{}l@{}}\rlap{\fontspec{Technika}\ctufield[title]{faculty}}\\[2pt]\fontspec{Technika}\ctufield[title]{department}\end{tabular}
		\end{tabular}
		\par
		% The document type
		\vspace{0cm}
		\selectctulanguage{title}
		{\fontspec{Technika}\ctufield[title]{doctype}\par}
		%
		\vspace{35mm}
		%
		% The title, in two languages
		{\color{ctubluetext}\Huge\fontspec{Technika}
		\ctufield[title]{title}\par}
		%
		%
		{\Large\color{ctubluetext}\fontspec{Technika}
		\ctufield[title]{subtitle}\par}
		%
		%
		\vspace{15mm}
		% The author
		{\Large\fontspec{Technika}
		\ctufield{author}}
		\\
		%
		...
		\parskip 1pt
		\ctuiffield*{supervisor}{\fontspec{Technika}\supervisorname :~{\frenchspacing\ctufield{supervisor}}\par}{}
		\ctuiffield*{supervisor-specialist}{\fontspec{Technika}\supervisorspecialistname :~{\frenchspacing\ctufield{supervisor-specialist}}\par}{}
		\ctuiffield*[title]{fieldofstudy}{\fontspec{Technika}\fieldofstudyname :~\ctufield[title]{fieldofstudy}\par}{}
		\ctuiffield*[title]{subfieldofstudy}{\fontspec{Technika}\subfieldofstudyname :~\ctufield[title]{subfieldofstudy}\par}{}
