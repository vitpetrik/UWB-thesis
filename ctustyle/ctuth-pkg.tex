...
\def\ttlh@ctuch#1#2#3#4#5#6#7#8{
	...
	\ctu@title@boxify{#5}{#3}{
		{\fontspec{Technika}#1\strut\ifttl@label#2\fi}
		\\
		{\fontspec{Technika}\Large\color{ctubluetext}#4\strut#8\strut}
	}{}
}
...
\def\ttlh@ctus#1#2#3#4#5#6#7#8{
	...
	\ctu@title@boxify@x{#5}{0pt}{#3}{ #1{\fontspec{Technika}\ifttl@label#2\fi\strut\color{ctubluetext}#8\strut} }{}
}
...
\titleformat \chapter [ctuch] {\huge} {{\LARGE\chaptertitlename\ }\Huge\thechapter} {-0\dp\strutbox} {\LARGE} [0pt]
