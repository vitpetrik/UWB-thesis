...
\begin{abstract-english}
	For operation of multi robot systems it is crucial that each robot posses information of the whole system. 
	...
	Popular solution for such a problem is to employ visual relative localizations.

	This thesis discuss possible paths to improve measurements from visual relative localizations.
	Proposed soultions for this task are sensors based on Ultra-wide band technology.
	As our experiments show, the solutions offers high precision and low latency localization of multiple robots.
